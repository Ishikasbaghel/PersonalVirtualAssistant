        ...
        if(strcmp(password, "inertia")==0){
            ...
            do{
                ...
                if(strcmp(ch, "hi") == 0 || strcmp(ch, "hey") == 0 || strcmp(ch, "hello") == 0 ){
                    ...
                    cout<<"Good Bye maam, have a nice day!!!!"<<endl;
                    string phrase = "Good Bye maam, have a nice day";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    exit(0);
                    ...
                    cout<<"I'm a virtual assistant created by my master Ishika !!!"<<endl;
                    string phrase = "I am a virtual assistant created by my master Ishika";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                    ...
                    cout<<"I'm good maam, tell me how can i help you.."<<endl;
                    string phrase = "I'm good maam, tell me how can i help you";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
